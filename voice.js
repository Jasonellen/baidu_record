!function(e) {
    ...
    var d = function(e, t) {
                ...
                if (n) {
                    ...
                    i.always(function(t) {
                        if (t && "string" == typeof t) {
                            ...
                            n && (n = n[1]),
                            t = JSON.parse(t),
                            t.result && t.result.corpus_no && n && (t.result.corpus_no = n)
                        } else
                            t = null;
                        ...
                        v.result.fire(t)),
                        (t && t.result && (3 == t.result.res_type || 5 == t.result.res_type) || !t.result) && e.stop(!0),
        ...
        var g = new Worker(c.workerPath || o());
        g.postMessage({
            command: "init",
            config: {
                outputChannels: d,
        ...
        this.node.onaudioprocess = function(e) {
            if (m) {
                var t, n = [];
                for (t = 0; d > t; t++)
                    n.push(e.inputBuffer.getChannelData(t));
                r({
                    command: "record",
                    buffer: n
                }),
        ...
        e && e.addEventListener && e.addEventListener("ended", function() {
            v.noUserMedia.fire(),
            e.removeEventListener(arguments.callee)
        }),
    ...
    var g, p, m = !1, A = $("body"), v = function() {
        ...
        return function(u) {
            ...
            u.onfail(function(e) {
                ...
                e && e.result && "-3005" == e.result.err_no && (t = "没听清楚，请点击下面按钮后再说一次"),
                i.html(t),
                l(u),
...
"function" == typeof define && define("voice/js/voice", ["require"], function() {
